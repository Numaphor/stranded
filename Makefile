...
PYTHON      	:=  python
SOURCES     	:=  src src/player src/enemy src/scene src/collision src/ui src/level src/npc src/utils src/story butano/common/src
INCLUDES    	:=  include include/player include/enemy include/scene include/collision include/ui include/level include/npc include/utils include/story butano/common/include
DATA        	:=
