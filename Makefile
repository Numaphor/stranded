...
DATA        	:=
GRAPHICS    	:=  butano/common/graphics graphics/bg graphics/sprite/player graphics/sprite/npc graphics/sprite/hud graphics/sprite/decor graphics/shape_group_textures
AUDIO       	:=
DMGAUDIO    	:=
ROMTITLE    	:=  ROM TITLE
ROMCODE     	:=  SBTP
