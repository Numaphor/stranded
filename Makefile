...
PYTHON      	:=  python
SOURCES     	:=  src src/core src/actors src/validation/logging src/validation/background src/validation/dma src/validation/coords butano/common/src
INCLUDES    	:=  include butano/common/include
DATA        	:=
GRAPHICS    	:=  graphics butano/common/graphics graphics/bg graphics/sprite/player graphics/sprite/creature graphics/sprite/enemy graphics/sprite/npc graphics/sprite/vfx graphics/sprite/hud graphics/sprite/item
