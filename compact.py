...
with open('src/fe_player.cpp', 'r', encoding='utf-8') as f:
    content = f.read()
...
while i < len(lines):
    ...
    # Compact if/else with single statement (more aggressive)
    if i + 3 < len(lines):
    ...
    # Compact simple function bodies (more aggressive)
...
# Write result
with open('src/fe_player.cpp', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output))
