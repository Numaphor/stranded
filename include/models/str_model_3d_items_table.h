...
namespace str::model_3d_items
{
    constexpr inline fr::vertex_3d table_vertices[] = {
        fr::vertex_3d(-12.6, -8.4, -9.24),
        fr::vertex_3d(12.6, -8.4, -9.24),
        fr::vertex_3d(12.6, -8.4, -7.56),
        fr::vertex_3d(-12.6, -8.4, -7.56),
        fr::vertex_3d(-12.6, 8.4, -9.24),
        fr::vertex_3d(12.6, 8.4, -9.24),
        fr::vertex_3d(12.6, 8.4, -7.56),
        fr::vertex_3d(-12.6, 8.4, -7.56),
        fr::vertex_3d(-11.76, -7.56, -7.56),
        fr::vertex_3d(-10.08, -7.56, -7.56),
        fr::vertex_3d(-10.08, -7.56, 11.76),
        fr::vertex_3d(-11.76, -7.56, 11.76),
        fr::vertex_3d(-11.76, -5.88, -7.56),
        fr::vertex_3d(-10.08, -5.88, -7.56),
        fr::vertex_3d(-10.08, -5.88, 11.76),
        fr::vertex_3d(-11.76, -5.88, 11.76),
        fr::vertex_3d(-11.76, 5.88, -7.56),
        fr::vertex_3d(-10.08, 5.88, -7.56),
        fr::vertex_3d(-10.08, 5.88, 11.76),
        fr::vertex_3d(-11.76, 5.88, 11.76),
