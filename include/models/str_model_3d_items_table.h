...
namespace str::model_3d_items
{
    ...
    constexpr inline fr::face_3d table_faces[] = {
        ...
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 1.0, 0.0), 4, 5, 6, 7, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, -1.0), 7, 6, 1, 0, 9, -1),
        ...
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, 1.0), 8, 9, 10, 11, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 1.0, 0.0), 12, 13, 14, 15, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, -1.0), 15, 14, 9, 8, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, -1.0, 0.0), 13, 12, 11, 10, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(-1.0, 0.0, 0.0), 12, 15, 8, 11, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(1.0, 0.0, 0.0), 14, 13, 10, 9, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, 1.0), 16, 17, 18, 19, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 1.0, 0.0), 20, 21, 22, 23, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, -1.0), 23, 22, 17, 16, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, -1.0, 0.0), 21, 20, 19, 18, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(-1.0, 0.0, 0.0), 20, 23, 16, 19, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(1.0, 0.0, 0.0), 22, 21, 18, 17, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, 1.0), 24, 25, 26, 27, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 1.0, 0.0), 28, 29, 30, 31, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, -1.0), 31, 30, 25, 24, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, -1.0, 0.0), 29, 28, 27, 26, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(-1.0, 0.0, 0.0), 28, 31, 24, 27, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(1.0, 0.0, 0.0), 30, 29, 26, 25, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, 1.0), 32, 33, 34, 35, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 1.0, 0.0), 36, 37, 38, 39, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, 0.0, -1.0), 39, 38, 33, 32, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(0.0, -1.0, 0.0), 37, 36, 35, 34, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(-1.0, 0.0, 0.0), 36, 39, 32, 35, 9, -1),
        fr::face_3d(table_vertices, fr::vertex_3d(1.0, 0.0, 0.0), 38, 37, 34, 33, 9, -1)
    };
