...
namespace fe
{
    ...
    private:
        ...
        static constexpr bn::fixed CAMERA_FOLLOW_SPEED = 0.15;           // Much faster follow speed (15% per frame) for smooth movement
        static constexpr bn::fixed CAMERA_DIRECTION_CHANGE_SPEED = 0.08; // Faster direction changes (8% per frame) for smooth transitions
        static constexpr int CAMERA_DIRECTION_CHANGE_DURATION = 15;      // Shorter direction change duration (0.25 seconds at 60fps)
        static constexpr bn::fixed CAMERA_LOOKAHEAD_X = 80;              // Good horizontal lookahead distance
        static constexpr bn::fixed CAMERA_LOOKAHEAD_Y = 60;              // Good vertical lookahead distance
