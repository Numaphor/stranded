...
**Do NOT build code.** This command creates only planning artifacts under `.planning/` (PROJECT.md, REQUIREMENTS.md, ROADMAP.md, STATE.md, research/, config.json, intel/). Do not scaffold, generate, or write application code (no package.json, no source files, no boilerplate). Code is built later via `/gsd:plan-phase` and `/gsd:execute-phase`.

</objective>

<execution_context>

@.cursor/gsd/references/questioning.md
@.cursor/gsd/references/ui-brand.md
...
**Constraint:** Create only `.planning/` artifacts. Do not write application code, scaffold projects, or generate source files.
...
Use template: .cursor/gsd/templates/research-project/STACK.md
</output>
...
Use template: .cursor/gsd/templates/research-project/FEATURES.md
</output>
...
Use template: .cursor/gsd/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: .cursor/gsd/templates/research-project/PITFALLS.md
</output>
...
Use template: .cursor/gsd/templates/research-project/SUMMARY.md
