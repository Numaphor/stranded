...
```bash
cat .cursor/gsd/VERSION 2>/dev/null
```
...
- `.cursor/commands/` (GSD commands) may be wiped and replaced by updater
- `.cursor/gsd/` will be wiped and replaced
- `.cursor/agents/gsd-*` files may be replaced

Your custom files in other locations are preserved:
- Custom commands and agents not replaced by updater ✓
...
```bash
rm -f .cursor/cache/gsd-update-check.json
```
</step>
