...
namespace fe
{
    ...
    void Menu::_init_worlds()
    {
        ...
        _worlds.clear();
        _worlds.push_back(WorldData(0, "Main World", bn::fixed_point(50, 100), true));
        _worlds.push_back(WorldData(1, "Forest Area", bn::fixed_point(100, 50), true));
        _worlds.push_back(WorldData(2, "Desert Zone", bn::fixed_point(0, 150), true));
        _worlds.push_back(WorldData(3, "Ocean Side", bn::fixed_point(-50, 75), true));
    }
    ...
    void Menu::_update_display()
    {
        ...
        // Title
        text_generator.generate(0, -80, "WORLD SELECTION", _text_sprites);
        
        // Instructions
        text_generator.generate(0, 80, "UP/DOWN: Select  A: Enter  B: Exit", _text_sprites);
