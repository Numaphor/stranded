...
namespace fe
{
    ...
    NPC::NPC(bn::fixed_point pos, bn::camera_ptr &camera, NPC_TYPE type, bn::sprite_text_generator &text_generator) : _type(type),
                                                                                                                      _pos(pos),
                                                                                                                      _camera(camera),
                                                                                                                      _text_generator(text_generator)
    {
        ...
        else if (_type == NPC_TYPE::MERCHANT)
        {
            ...
            _lines = bn::span(_merchant_lines);
        }
